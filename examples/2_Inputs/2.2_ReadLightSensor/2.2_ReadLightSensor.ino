...
Activities:
1. What is the highest light value the sensor can detect? (try using your cell phone flashlight)
2. What is the lowest light value the sensor can detect? (cover it with your finger)
